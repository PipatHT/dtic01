//คำนวณผลรวม และค่าเฉลี่ยจากตัวเลขที่รับมาทางแป้นพิมพ์ 3 จำนวน เเละเเสดงผลทางหน้าจอ

//input? output? process?

//feature การทำงานอะไรบ้าง?
//รับค่าตัวเลข 3 จำนวนจากแป้นพิมพ์ม, คำนวณผลรวม, คำนวณค่าเฉลี่ย, เเสดงผลรวม, เเสดงค่าเฉลี่ย, แสดงชื่อโปรแกรม
